...
Desktop mod manager for PC games (focused on Cyberpunk 2077). Scans, groups, correlates, and manages mods with Nexus Mods integration. Ships in two editions from this repo: Full (this branch, `main`) and Nexus-compliant (`nexus-compliant` branch, no auto-updater).
...
- 809+ tests across `backend/tests/` (routers, services, matching, scanner, nexus, archive)
