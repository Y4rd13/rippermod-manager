    ...
    >
      ...
      <div className="border-t border-border p-2">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-text-secondary hover:bg-surface-2 hover:text-text-primary transition-colors"
        >
